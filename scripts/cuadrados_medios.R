...
semilla <- readline(prompt="Ingrese la semilla (4 digitos): ")
semilla <- as.integer(semilla) # convert character into integer
...
if(longitud_semilla >= 4){
  ...
  iteraciones <- readline("Ingrese cantidad de iteraciones: ")
  iteraciones <- as.integer(iteraciones)
